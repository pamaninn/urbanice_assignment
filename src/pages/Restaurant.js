...
function Restaurant(props) {
  ...
  return (
      ...
      {zeroResult ? <Grid container >No results</Grid>:
      <Grid container spacing={{xs:6}} columns={{xs:4,sm:8,md:12}} sx={{marginTop:0}}>
      {restaurant.map((item,index) => (
        
        <RestaurantCard item={item} apiKey={apiKey} index={index} key={index}/>
